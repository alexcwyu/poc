...
class RiskPublisher(brokers: String, val topic: String){
    ...
    init{
        ...
        props[ProducerConfig.VALUE_SERIALIZER_CLASS_CONFIG] = ByteArraySerializer::class.java.canonicalName
...
class RiskConsumer(brokers: String, val topic: String){
...
fun main(args: Array<String>) {
    val publisher = RiskPublisher("localhost:29092", "risk")
    val consumer = RiskConsumer("localhost:29092", "risk")
