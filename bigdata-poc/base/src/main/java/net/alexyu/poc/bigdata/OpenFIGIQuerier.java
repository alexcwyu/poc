...
public class OpenFIGIQuerier {

    public static void main(String[] args) throws Exception {
        OpenFIGIQuerier app = new OpenFIGIQuerier();
        String apiKey = "5f847421-8d12-486f-a303-7074f31ed0dc";
        ...
        jobs.add(app.createJob("TICKER", "AAPL").currency("USD"));
