 ...
 */
package net.alexyu.poc.model.avro;
...
public class MarketData extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -5458163150477455231L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"MarketData\",\"namespace\":\"net.alexyu.poc.model.avro\",\"fields\":[{\"name\":\"instid\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"type\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"time\",\"type\":\"long\"},{\"name\":\"value\",\"type\":\"double\"}]}");
   ...
   */
  public static net.alexyu.poc.model.avro.MarketData.Builder newBuilder() {
    return new net.alexyu.poc.model.avro.MarketData.Builder();
  }
   ...
   * @return A new MarketData RecordBuilder
   */
  public static net.alexyu.poc.model.avro.MarketData.Builder newBuilder(net.alexyu.poc.model.avro.MarketData.Builder other) {
    return new net.alexyu.poc.model.avro.MarketData.Builder(other);
  }
   ...
   * @return A new MarketData RecordBuilder
   */
  public static net.alexyu.poc.model.avro.MarketData.Builder newBuilder(net.alexyu.poc.model.avro.MarketData other) {
    return new net.alexyu.poc.model.avro.MarketData.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<MarketData>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(net.alexyu.poc.model.avro.MarketData.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(net.alexyu.poc.model.avro.MarketData other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.instid)) {
        this.instid = data().deepCopy(fields()[0].schema(), other.instid);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.alexyu.poc.model.avro.MarketData.Builder setInstid(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.alexyu.poc.model.avro.MarketData.Builder clearInstid() {
      instid = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.alexyu.poc.model.avro.MarketData.Builder setType(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.alexyu.poc.model.avro.MarketData.Builder clearType() {
      type = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.alexyu.poc.model.avro.MarketData.Builder setTime(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.alexyu.poc.model.avro.MarketData.Builder clearTime() {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.alexyu.poc.model.avro.MarketData.Builder setValue(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.alexyu.poc.model.avro.MarketData.Builder clearValue() {
