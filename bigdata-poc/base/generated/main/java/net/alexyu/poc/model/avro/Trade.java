...
public class Trade extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 5463075224979655471L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Trade\",\"namespace\":\"net.alexyu.poc.model.avro\",\"fields\":[{\"name\":\"instid\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"time\",\"type\":\"long\"},{\"name\":\"price\",\"type\":\"double\"},{\"name\":\"qty\",\"type\":\"double\"}]}");
   ...
   */
  public static net.alexyu.poc.model.avro.Trade.Builder newBuilder() {
    return new net.alexyu.poc.model.avro.Trade.Builder();
  }
   ...
   * @return A new Trade RecordBuilder
   */
  public static net.alexyu.poc.model.avro.Trade.Builder newBuilder(net.alexyu.poc.model.avro.Trade.Builder other) {
    return new net.alexyu.poc.model.avro.Trade.Builder(other);
  }
   ...
   * @return A new Trade RecordBuilder
   */
  public static net.alexyu.poc.model.avro.Trade.Builder newBuilder(net.alexyu.poc.model.avro.Trade other) {
    return new net.alexyu.poc.model.avro.Trade.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Trade>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(net.alexyu.poc.model.avro.Trade.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(net.alexyu.poc.model.avro.Trade other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.instid)) {
        this.instid = data().deepCopy(fields()[0].schema(), other.instid);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.alexyu.poc.model.avro.Trade.Builder setInstid(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.alexyu.poc.model.avro.Trade.Builder clearInstid() {
      instid = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.alexyu.poc.model.avro.Trade.Builder setTime(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.alexyu.poc.model.avro.Trade.Builder clearTime() {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.alexyu.poc.model.avro.Trade.Builder setPrice(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.alexyu.poc.model.avro.Trade.Builder clearPrice() {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.alexyu.poc.model.avro.Trade.Builder setQty(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.alexyu.poc.model.avro.Trade.Builder clearQty() {
